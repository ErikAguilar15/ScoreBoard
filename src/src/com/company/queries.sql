...
INSERT INTO Coach (c_name, c_coachID, c_teamID, c_sport, c_league, c_division, c_schoolID, c_state) VALUES
(JOHN GRUDEN, 1, 1, FOOTBALL, VALLEY, 1, 1, CA),
(JAY GRUDEN, 2, 2, FOOTBALL, VALLEY, 1, 2, NY),
(JOHN MADDEN, 3, 3, FOOTBALL, VALLEY, 1, 3, NY),
(FLORIN RUSU, 4, 4, FOOTBALL, VALLEY, 1, 4, LA),
(MIKE MICHAELS, 5, 5, FOOTBALL, VALLEY, 1, 5, CA),
(MIKE JONES, 6, 6, FOOTBALL, MEL, 2, 6, WA),
(MIKE TOMLINSON, 7, 7, FOOTBALL, MEL, 2, 7, CA),
(JAMES WHITE, 8, 8, FOOTBALL, MEL, 2, 8, CA),
(TOM HOTHEM, 9, 9, FOOTBALL, MEL, 2, 9, NV),
(JIM BROWN, 10, 10, FOOTBALL, MEL, 2, 10, AZ)
(MIKE BROWN, 11, 11, BASKETBALL, VALLEY, 1, 1, CA),
(GREG POPOVICH, 12, 12, BASKETBALL, VALLEY, 1, 2, NY),
(STEVE KERR, 13, 13, BASKETBALL, VALLEY, 1, 3, NY),
(KOBE BRYANT, 14, 14, BASKETBALL, VALLEY, 1, 4, LA),
(MICHAEL JORDAN, 15, 15, BASKETBALL, VALLEY, 1, 5, CA),
(TIM TEBOW, 16, 16, BASKETBALL, MEL, 2, 6, WA),
(DRAKE, 17, 17, BASKETBALL, MEL, 2, 7, CA),
(LIL WAYNE, 18, 18, BASKETBALL, MEL, 2, 8, CA),
(DANIEL HERNANDEZ, 19, 19, BASKETBALL, MEL, 2, 9, NV),
(YOUNG THUG, 20, 20, BASKETBALL, MEL, 2, 10, AZ);
